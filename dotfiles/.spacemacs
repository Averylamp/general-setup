...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ( json :variables json-fmt-tool 'web-beautify json-fmt-on-save t json-backend 'lsp)
     markdown
     multiple-cursors
     nginx
     org
