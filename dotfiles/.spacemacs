  ...
  (setq-default
   ...
   '(
     ...
     (python :variables python-enable-yapf-format-on-save
             t python-sort-imports-on-save t)
     (yaml :variables
           yaml-enable-lsp t
           yaml-yamllint t
           )
